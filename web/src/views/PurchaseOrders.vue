...
const rows=ref<any[]>([]), suppliers=ref<any[]>([]), customers=ref<any[]>([])
const supplierId=ref<number|null>(null), customerId=ref<number|null>(null), dialogVisible=ref(false), selectedId=ref<number|null>(null)
